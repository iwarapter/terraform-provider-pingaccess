...
func (r genericPluginResource) UpgradeResourceState(_ context.Context, req *tfprotov5.UpgradeResourceStateRequest) (*tfprotov5.UpgradeResourceStateResponse, error) {
	var t tftypes.Type
	switch req.Version {
	case 0:
		t = tftypes.Object{
